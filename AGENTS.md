...
- Keep full photo output as JPEG at 2048px wide and thumbnail output as JPEG at 640px wide unless the user asks for different standards.
...
- Map pins use Leaflet markers over OpenStreetMap tiles, with a small custom in-app clustering layer in `script.js`. If changing providers, preserve attribution and keep the site static/GitHub Pages compatible.
